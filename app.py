...
DATASET = [
    ...
    'Koplkkkk. Mau tunjang rumah tunjangan apapun tidak adil buat rakyat kecil.',
    ...
    'Tunjangan rumah kata mereka yaaaaa terserahlaaaa,kalian berjoget kami nenontonkalian.',
    ...
    'Tunggu saja Revolusi itu akan terjadi ada waktu dan saatnya Rakyat Indonesia bergerak.',
    ...
    'begini kah hidup di indonesia dan begini kah yang diingin kan oleh para leluhur warga menangis karena kemeskinan',
    'jangan makan uang rakyat mikirin orang-orang yang nggak mampu yang miskin yang mulung',
    'Cokk aku sebagai rakyat tidak ridho gaji anggota dewan dinaikkan begitu juga konpensasi rumah juga dinaikkan',
    'yg kaya makin kaya yg miskin makin miskin',
    'Aku org Malaysia ketar ketir....😊😊😊 Gji DPR anggota Parlimen dibyar ratusan Juta RP....Gaji Guru hnya dibyar 300 Ribu..',
    ...
    'tidak punya malu, di saat rakyat menderita di cekik bayar pajak, mereka malah joget² dapat kenaikan gaji...',
    'itulah anggota dpr pintar bersilat lidah, gaji di ganti nama menjadi tunjangan...',
    ...
    'Pikiran jelek sy bnr di naikan gaji dngn atas namakan kopensasi UANG rumah tinggl .',
    'rakyat menangis,mbok ya lebih memikirkan nasib rakyat dari kalangan menengah k bawah ibu /bpk yg terhormat',
    'Yang kaya makin kaya..yang miskin makin miskin',
    'Rombongan orang miskin, telor bensin rumah beras, minta ditunjangan, yang bayar rakyat lewat pajak',
    'kenaikan tunjangan anggota dpr dibayar dengan menaikan pajak yg semakin mencekik rakyat...... BIADAP',
    'RAKYAT SANGAT KESULITAN BUAT BELI BERAS, EHH ANGOTA DPR MALAH DAPAT TUNJANGAN BERAS, SANGAT MENYEDIHKAN.',
    'Yg kaya makin kaya yg miskin makin miskin itulah negara kita Indonesa',
    'Sementara rakyat sibuk tiap hari dari pagi sampai malam peras keringat banting tulang cuma buat mencari sesuap nasi.',
    'Mental bobrok pada di jadikan anggota dewan ...lebih tepatnya mereka itu cuma makan gajih buta',
    'Bubar kn DPR penipu ranya ngk ada gunanya',
    'Negara konoha benar benar negara bobrok yang kerja berat keringat sampe kelubang pantat',
    'DPR enak pa naik gaji saya warga miskin kesusahan jualan aja sepi barang sembako pada naik ,',
    'Gaji banyak insaalloh musibanya jugak banya soalnya menyangkut masarakat banyak ygsengsara',
    'Yang terekam lagi joged harusnya malu sak malu2nya.. dilihat anak, keluarga, kerabat dan tetangga dirumah..',
    'Wah tambah enak hidup ny PR wakil rkyt, hidupny sngt trjamin, yg ky mkn ky, yg miskin kckik msalh ekonomi',
    'Suatu malam, Umar bin Khattab r.a. keluar sendirian untuk memantau keadaan rakyatnya.',
    'Menari di atas penderitaan rakyat miskin',
    'Fungsi DPR apa sih . Masyarakat diluaran sana masih bnyak yg kekurangan',
    'DPR, Pemerintah dan Lembaga yang menaikkan gaji anggota DPR, harusnya menaikkan taraf hidup rakyat',
    ...
    'Ayo di demo lagi, itu tunjangan perumahan yg 50 jt bukan di hilangin tapi di pindahin ke tunjangan reses',
    'ih geramnyo \nDPR Jelek',
    ...
    'Video joget itu kan setelah rapat tahunan, tapi kalian malah sandingkan video itu',
    'Jika pembahasan kalian tentang gaji anggota dewan, itu bertolak belakang dengan video Anggita dewan',
    'Hey cnn apakah kalian tidak sadar, dengan kesalahan kalian yang bikin demo kemarin',
    'Dpr anj',
    'Kerja seumur hidup gaji kecil tanpa pensiun, kerja 5 tahun ngantor saat ada rapat ada pensiun',
    ...
    'AndaikAn gaji PNS dan dpr serta karyawan di negeri ini paling tinggi 30 jt dan terkecil 10 jt',
    'kenapa pajak kita paling tinggi dari negara lain???karena buat bayarin monyet2 dpr',
    'Harus di batalkan tunjangan apa pun, masyarakat di bawah masih ada yang hanya minum air putih',
    'D P R❗🙌\nDewan Perwakilan Rakyat😮❓\nWakil rakyat Naik mercy😳',
    'Nanggung jendral,kasih mereka 1 M per bulan biar aman jabatan anda...',
    ...
    'Di Indonesia itu pengenya gaji DPR disetarakan dgn parlement di eropa',
    ...
    # --- Tambahan 100 Komentar Baru (Bahasa Baku) ---
    ...
    'Moralitas publik menuntut para pemimpin untuk selalu bersikap bijaksana dalam menggunakan fasilitas negara.',
...
with st.container():
    ...
    with col_input:
        st.markdown("<p style='font-weight: 600; margin-bottom: 5px;'>Pilih Komentar Sampel (200 Data):</p>", unsafe_allow_html=True)

        st.selectbox(
            label="Komentar Sampel",
            options=["-- ATAU KETIK SENDIRI DI BAWAH --"] + DATASET,
            key="selected_sample",
